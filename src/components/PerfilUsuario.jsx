...
export default function PerfilUsuario() {
    ...
    if (profileLoading) return <div className="p-8 text-center text-slate-500">Cargando perfil...</div>;
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                            <div className="w-20 h-20 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-4">
                                {nombre ? nombre[0].toUpperCase() : (profile?.email ? profile.email[0].toUpperCase() : "?")}
                            </div>
                        ...
                        >
                            ...
                            <p className="text-indigo-100 text-xs text-pretty italic">Gestiona tus datos bancarios y sus alias (ej: Mercado Pago) para tus recibos.</p>
                        </div>
                    </div>

                    <div className="md:col-span-2">
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                            <h3 className="text-lg font-bold text-slate-800 mb-6 border-b pb-4">Configuración del Usuario</h3>
