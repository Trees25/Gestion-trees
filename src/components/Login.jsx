  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (err.message === "Failed to fetch") {
        setError("Error de conexión: No se pudo contactar con Supabase. Verificá tu internet o si el servicio está caído.");
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 px-4">
      <div className="max-w-md w-full">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium"
        ...
        <p className="text-center text-slate-500 text-sm mt-8">
          © {new Date().getFullYear()} Trees Gestión. Todos los derechos reservados.
        </p>
      </div>
    </div>
  );
