...
export default function Clientes() {
    ...
    const handleAgregar = async (e) => {
        ...
        if (error) {
            ...
            setNuevoCliente({ nombre: "", dni_cuit: "", email: "", telefono: "", direccion: "" });
            cargarClientes();
        }
    };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                            <h3 className="text-lg font-bold text-slate-800 mb-6">Nuevo Cliente</h3>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-slate-100">
                                        ...
                                        {clientes.length === 0 && (
                                            <tr>
                                                <td colSpan={4} className="py-12 text-center text-slate-400 italic">No hay clientes registrados</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>
