...
export default function Recibo() {
  ...
  const descargarPDF = () => {
    ...
    doc.text(`Recibí de: ${selectedCliente?.nombre || "No especificado"}`, 10, 35);
    ...
    <div className="min-h-screen bg-slate-50 pb-12">
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-wrap gap-3 mb-8">
          <button onClick={() => navigate("/admin")} className="px-4 py-2 bg-white border rounded-lg text-sm">← Inicio</button>
        ...
        <div className="bg-white rounded-2xl shadow-sm border p-8">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold text-slate-800">Generar Recibo</h2>
            <div className="bg-slate-100 px-4 py-2 rounded-lg font-bold">N° {contador}</div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div>
              <label className="block text-sm font-medium mb-1">Recibí de *</label>
              <select
