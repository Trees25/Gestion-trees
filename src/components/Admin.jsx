    ...
    <div className="min-h-screen bg-slate-50 pb-12">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mt-12 mb-6">
          <h3 className="text-xl font-bold text-slate-800 border-b border-slate-200 pb-2">Sistemas Integrados</h3>
          <p className="text-sm text-slate-500 mt-2">Módulos y conexiones con software externo.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            className="group relative bg-white p-6 rounded-2xl shadow-sm border border-slate-100 cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 active:scale-[0.98]"
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-1">Posventa</h3>
              <p className="text-sm text-slate-600">Suscripciones y clientes del sistema Posventa</p>
            </div>
          </div>
        </div>
      </div>
